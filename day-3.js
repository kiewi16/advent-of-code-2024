...
// const data2 = "xmul(2,4)%&mul[3,7]!@^do_not_mul(5,5)+mul(32,64]then(mul(11,8)mul(8,5))"

// const regex = /mul\(\d{1,3},\d{1,3}\)/g
// const uncorruptedData = data2.match(regex)

// console.log("uncorruptedData1:", uncorruptedData)
...
//     return total
// }
// console.log("total", findNumbersOnly(uncorruptedData))